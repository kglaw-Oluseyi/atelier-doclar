...
| Finding | LayoutValidationFinding | `layoutValidationFindings` | finding | rule/evidence/status | Material edits mark STALE. |
| Override | LayoutValidationOverride | `layoutValidationOverrides` | override | authorised exception | Reason, evidence, authority, expiry, audit. |
...
| Journal | S05MigrationReceipt | `s05MigrationReceipts` | migration | migration receipt | Checksum-protected, replay-safe. IDs `EOS-S05-VENUE-LAYOUT-V1`, `EOS-S05-VENUE-OBJECTS-V1`, `EOS-S05-VENUE-ASSURANCE-V1`. |
