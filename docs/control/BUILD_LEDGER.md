...
| EOS-S04B | MD-PR-S018 | Multi-phase / routing / perimeter | EVENT_OS | pending first vertical | IN_PROGRESS | CEO-ratified 2026-09-07. Controlling pack `Maison_Doclar_EOS-S04B_Cursor_Prompt_Pack_v1.0.docx` subject to authority overlay. Not a catalogue slice. Production not authorised. EOS-S04C–F and EOS-S05 not started. |
