...
| EOS-S04B | MD-PR-S018 | Multi-phase / routing / perimeter | EVENT_OS | `c6bde2d5b75e1e40ec50036d000fd5f0999060fc` | IN_PROGRESS | First complete vertical. Ratification `bbf75b6`. Platform `3eac4d1`. Frontend `f1142af`. Tests `c6bde2d`. Not a catalogue slice. Production not authorised. EOS-S04C–F and EOS-S05 not started. |
