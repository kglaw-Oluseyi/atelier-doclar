...
| EOS-S05 | IN_PROGRESS — Venue registry and spatial layout; catalogue slice; Milestone 1 only; `MD-PR-S028`; not accepted |
...
| Band | Content |
|------|---------|
| Now | Event OS S01–S03 accepted; EOS-S04 CLOSED / ACCEPTED; EOS-S04A–F ACCEPTED (S04A–F are not catalogue slices); EOS-S05 Milestone 1 IN_PROGRESS under `MD-PR-S028`; production unsigned; no real communication or translation provider |
