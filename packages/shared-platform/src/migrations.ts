...
import {
  ...
  CPSAT_DURABLE_SEATING_EVALUATION_POSTGRES_SCHEMA,
...
export const PLATFORM_MIGRATIONS: readonly PlatformMigration[] = [
  ...
  {
    id: EOS_S06_CPSAT_CANONICAL_SEATING_CUTOVER_MIGRATION_ID,
    sql: CPSAT_CANONICAL_SEATING_CUTOVER_POSTGRES_SCHEMA,
  },
  {
    id: EOS_S06_CPSAT_DURABLE_SEATING_EVALUATION_MIGRATION_ID,
    sql: CPSAT_DURABLE_SEATING_EVALUATION_POSTGRES_SCHEMA,
  },
];
