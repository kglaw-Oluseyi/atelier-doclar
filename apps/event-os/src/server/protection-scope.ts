...
export function protectionPermissions(person: Person, organisationId: string, eventId?: string) {
  ...
  return {
    ...
    dossierAssemble: allow("risk.dossier.assemble"),
    dossierSubmit: allow("risk.dossier.submit"),
    dossierApprove: allow("risk.dossier.approve"),
    dossierPublish: allow("risk.dossier.publish"),
    dossierExport: allow("risk.dossier.export"),
    dossierManageClientAccess: allow("risk.dossier.client_access.manage"),
